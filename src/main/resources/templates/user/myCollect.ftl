...
<div class="col-xs-9 individual-content">
    ...
    <#if userCollectPageLists.getData()?? && userCollectPageLists.getData()?size gt 0>
        <div class="panel ">
            <div class="panel-body">
                <div class="articles">
                    <#list userCollectPageLists.getData() as article>
                        <div class="article">
        ...
        <div class="panel">
            <div class="panel-body" style="text-align: center">
                <ul class="pager pager-pills" style="">
                    ...
                    <#if userCollectPageLists.currentPage lte 1>
                        <li class="previous disabled">
                            <a href="javaScript:void(0)"><i class="icon icon-chevron-left"></i></a>
                        </li>
                    <#else >
                        <li class="previous" onclick="getNewData('${userCollectPageLists.currentPage-1}')">
                            <a href="javaScript:void(0)"><i class="icon icon-chevron-left"></i></a>
                        </li>
                    </#if>
                    <li>
                        <a href="javaScript:void(0)" class="btn">第${userCollectPageLists.currentPage}
                            页/共${userCollectPageLists.getTotalPages()}
                            页</a>
                    </li>
                    <#if userCollectPageLists.currentPage gte userCollectPageLists.getTotalPages()>
                        <li class="next disabled">
                            <a href="javaScript:void(0)"><i class="icon icon-chevron-right"></i></a>
                        </li>
                    <#else>
                        <li class="next" onclick="getNewData('${userCollectPageLists.currentPage+1}')">
                            <a href="javaScript:void(0)"><i class="icon icon-chevron-right"></i></a>
                        </li>
                    </#if>
                    <li class="previous" onclick="getNewData('${userCollectPageLists.getTotalPages()}')">
...
<script>
    ...
    // 取消收藏
    function delCollect(articleId) {
        if (confirm("请确认是否取消收藏!")) {
    ...
    function getNewData(pageNum) {
        ...
        window.location.href = "/user/myArticles?pageNum=" + pageNum;
    }
    ...
    function renderPage() {
        ...
        let totalPage = '${userCollectPageLists.getTotalPages()}';
